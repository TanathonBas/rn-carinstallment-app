                ...
                <View style={styles.inputContainer}>
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                        {DOWN_PAYMENT.map((item) => (
                            <TouchableOpacity
                                key={item}
                                style={[styles.downPayment,
                                carDownPayment === item.toString() && styles.downPaymentSelect]}
                                onPress={() => setCarDownPayment(item.toString())}>
                                <Text style={[styles.downLabel,
                                carDownPayment === item.toString() && styles.downLabelSelect]}>
                                    {item}%
                                </Text>
                            </TouchableOpacity>
                        ))}
                    ...
                    <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
                        {MONTH_OPTION.map((item) => (
                            <TouchableOpacity key={item}
                                style={[styles.monthOption, carMonth === item.toString() && styles.monthOptionSelect]}
